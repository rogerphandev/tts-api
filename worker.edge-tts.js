/**
 * =========================================================
 * EDGE TTS - CLOUDFLARE WORKERS (FULL FEATURED & FIXED 403)
 * =========================================================
 *
 * Supported Queries:
 * - Synthesis: ?engine=edge&text=Xin%20chao&voice=vi-VN-HoaiMyNeural
 * - Groups list: ?engine=edge&action=groups
 * - Voices list: ?engine=edge&action=voices-by-group&group=vi-VN
 *
...
/* =========================================================
   SEC-MS-GEC (BIGINT TICK CALCULATION FIX FOR 403/TIMEOUT)
========================================================= */
...
export async function getEdgeVoices() {
  const url = `${VOICES_URL}?trustedclienttoken=${encodeURIComponent(TRUSTED_CLIENT_TOKEN)}`;
